...
import br.com.tech4me.primeirorest.service.PessoaService;
import br.com.tech4me.primeirorest.view.model.PessoaModeloDetalheResponse;
import br.com.tech4me.primeirorest.view.model.PessoaModeloRequest;
import br.com.tech4me.primeirorest.view.model.PessoaModeloResponse;
...
public class PessoaController {
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<PessoaModeloDetalheResponse> obterPorId(@PathVariable String id) {
        Optional<PessoaDto> pessoa = service.obterPorId(id);

        if(pessoa.isPresent()) {
            return new ResponseEntity<>(
                new ModelMapper().map(pessoa.get(), PessoaModeloDetalheResponse.class), 
                HttpStatus.OK
            );
        }
